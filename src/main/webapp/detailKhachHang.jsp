...
<div class="row">
    <form action="/update/khachhang?id=${khachhang.id}" class="row g-3 needs-validation" method="post">
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput1" class="form-label">Họ tên</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="hoten" placeholder="" value="${khachhang.hoTen}">
        </div>
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput6" class="form-label">Địa chỉ</label>
            <input type="text" class="form-control" id="exampleFormControlInput6" name="diachi" placeholder="" value="${khachhang.diaChi}">
        </div>
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput7" class="form-label">Số điện thoại</label>
            <input type="text" class="form-control" id="exampleFormControlInput7" name="sodt" placeholder="" value="${khachhang.sdt}">
        </div>
