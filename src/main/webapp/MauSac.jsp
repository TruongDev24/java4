...
<div style="text-align: center; margin-top: 30px"><h2><b>Màu sắc</b></h2></div>
<hr>
<br>
<div class="row">
    <form action="/ServletMauSize/Mau/add" class="row g-3 needs-validation" method="post">
...
<table class="table table-striped-columns">
    ...
    <tbody>
    <c:forEach items="${mau}" var="m" varStatus="i">
        <tr>
            <td>${m.id}</td>
            <td>${m.ma}</td>
            <td>${m.ten}</td>
            ...
            <td>${m.ngaySua}</td>
            <td>
                <a href="/ServletMauSize/Mau/detail?id=${m.id}" class="btn btn-info">Detail</a>
                <a onclick="" href="/ServletMauSize/Mau/delete?id=${m.id}" class="btn btn-danger">Delete</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
