...
<div class="row">
    <form action="/update/danhmuc?id=${dmuc.id}" class="row g-3 needs-validation" method="post">
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput1" class="form-label">Mã danh mục</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="ma" placeholder="" value="${dmuc.ma_danh_muc}">
        </div>
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput6" class="form-label">Tên danh mục</label>
            <input type="text" class="form-control" id="exampleFormControlInput6" name="ten" placeholder="" value="${dmuc.ten_danh_muc}">
        </div>
            ...
            <div style="display: flex">
                <div class="form-check" style="margin-right: 60px">
                    <input class="form-check-input" type="radio" name="Rdo" id="flexRadioDefault2" value="Active"
                           <c:if test="${dmuc.trang_thai == 'Active'}">checked</c:if>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="Rdo" id="flexRadioDefault1" value="Inactive"
                           <c:if test="${dmuc.trang_thai == 'Inactive'}">checked</c:if>>
