...
<div class="row">
    <form action="/ServletMauSize/Size/update?id=${size.id}" class="row g-3 needs-validation" method="post">
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput1" class="form-label">Mã size</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="ma" placeholder="" value="${size.ma}">
        </div>
        <div class="col-6 col-lg-6">
            <label for="exampleFormControlInput6" class="form-label">Tên size</label>
            <input type="text" class="form-control" id="exampleFormControlInput6" name="ten" placeholder="" value="${size.ten}">
        </div>
